...
export default function EditOrderModal({ order, onClose, onModifyOrder }: EditOrderModalProps) {
        ...
        <div className="flex items-center justify-between p-6 border-b border-gray-200">
          <div>
            ...
            <p className="text-sm text-gray-600">
              Order: {order.orderNumber || order.id.slice(-8)} | Table: {order.tableNumber}
            </p>
          </div>
          <button
            onClick={onClose}
