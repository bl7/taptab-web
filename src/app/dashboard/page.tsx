...
export default function DashboardPage() {
  ...
  useEffect(() => {
    const loadDashboardData = async () => {
      try {
        ...
        const [overview, liveOrders, popularCombinations, revenueTrend, tables] = await Promise.all([
  ...
  const LiveOrdersCard = () => {
    const getTableName = (tableNumber: string) => {
      const table = dashboardData?.tables.find(t => t.number === tableNumber);
          ...
          {dashboardData?.liveOrders.map((order) => (
            <div key={order.id} className="flex items-center justify-between p-3 border border-gray-100 rounded-lg hover:bg-gray-50">
              <div className="flex items-center space-x-3">
                ...
                <div>
                  <p className="text-sm font-medium text-gray-900">{getTableName(order.tableNumber)}</p>
        ...
        {dashboardData?.popularCombinations.map((combo, index) => (
          <div key={index} className="flex items-center justify-between p-3 border border-gray-100 rounded-lg">
            <div className="flex-1">
              <p className="text-sm font-medium text-gray-900">{combo.combination}</p>
        ...
        <div className="h-64 relative">
          ...
          <div className="ml-12 h-full relative">
            ...
            <svg className="w-full h-full" viewBox="0 0 100 100" preserveAspectRatio="none">
              ...
              <path
                d={`M 0,100 ${dailyData.map((day, index) => {
    ...
    <div className="space-y-8 p-6">
      ...
      <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <Link href="/dashboard/order-taking" className="p-4 border border-gray-200 rounded-xl hover:border-green-300 hover:bg-green-50 transition-colors">
          ...
          <Link href="/dashboard/analytics" className="p-4 border border-gray-200 rounded-xl hover:border-blue-300 hover:bg-blue-50 transition-colors">
            <BarChart3 className="w-6 h-6 text-blue-600 mb-2" />
            <p className="text-sm font-medium text-gray-900">Analytics</p>
            <p className="text-xs text-gray-500">View reports</p>
          </Link>
          
          <Link href="/dashboard/menu" className="p-4 border border-gray-200 rounded-xl hover:border-purple-300 hover:bg-purple-50 transition-colors">
          ...
          <Link href="/dashboard/staff" className="p-4 border border-gray-200 rounded-xl hover:border-orange-300 hover:bg-orange-50 transition-colors">
      ...
      <div className="bg-white rounded-xl p-6 border border-gray-200 shadow-sm">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {Object.entries(dashboardData.summary.paymentMethods).map(([method, data]) => (
            <div key={method} className="text-center p-4 border border-gray-100 rounded-lg hover:bg-gray-50 transition-colors">
